...
def add_tegenrekening_keywords(category):
    ...
    category['Cadeaus'] .keywords_naam_tegenrekening= ['foodelicious', 'ici paris']
    ...
    category['Horeca'].keywords_naam_tegenrekening = ['louis hartlooper', 'takeaway', 'thuisbezorgd', 'uit eten']
    ...
    category['Gepind'].keywords_naam_tegenrekening = []
...
def add_omschrijving_keywords(category):
    ...
    category['Boodschappen'].keywords_omschrijving = ['jumbo', 'ah', 'albert heijn', 'lidl', 'ekoplaza', 'plus', 'natuurwinkel', 'albertheijn', 'aldi', 'coop', 'netto', 'dirk', 'sweetgreen', 'spar', 'Boon\'s', 'Odin', 'McD', 'BOONS', 'blokker', 'hema', 'zeeman', 'kruidvat', 'primera']
    ...
    category['Woning'].keywords_omschrijving = ['Huisgeld', 'Airbnb', 'intratuin', 'bloem']
    ...
    category['Belastingen'].keywords_omschrijving = ['gemeente']
    category['Horeca'].keywords_omschrijving = ['Ledig Erf', 'Orca', 'Falafel City', 'Orloff', 'Cafe', 'Vegan', 'Dikke Dries', 'Smullers', 'Lunchroom', 'Manneken Pis', 'Eethuis', 'Ladage', 'eten', 'DONER', 'Una Mas', 'Poema', 'SLA', 'LaPlace', 'Pandje', 'Snackbar', 'Food Village', 'Barlow', 'KOFFIE', 'broei', 'lantaren']
    category['Feesten'].keywords_omschrijving = ['Festival', 'TIVOLI', 'EKKO', 'GROTE ZAAL', 'Filmcafe', 'punk dog']
    category['Goede doelen'].keywords_omschrijving = []
    category['Vaste lasten'].keywords_omschrijving = ['RENTE', 'vpn']
    category['Online bestellingen'].keywords_omschrijving = []
    category['Zorg'].keywords_omschrijving = ['fysiotherapie', 'praxis']
    ...
    category['Gepind'].keywords_omschrijving= ['ING                   ', 'geldautomaat']
